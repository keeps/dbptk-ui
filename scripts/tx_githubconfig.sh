...
yq -i '.git.filters[0].source_file="src/main/resources/config/i18n/ServerMessages.properties"' $CONFIG
yq -i '.git.filters[0].translation_files_expression="src/main/resources/config/i18n/ServerMessages_<lang>.properties"' $CONFIG
...
yq -i '.git.filters[1].source_file="src/main/resources/config/i18n/client/ClientMessages.properties"' $CONFIG
yq -i '.git.filters[1].translation_files_expression="src/main/resources/config/i18n/client/ClientMessages_<lang>.properties"' $CONFIG

map "src/main/resources/config/theme" '.html' 'HTML'
