...
import com.databasepreservation.main.common.shared.client.widgets.wcag.AccessibleCellTable;
import com.databasepreservation.main.common.shared.client.widgets.wcag.AccessibleSimplePager;
...
public abstract class AsyncTableCell<T extends IsIndexed, O> extends FlowPanel
  ...
  protected Handler<T> getSelectionEventManager() {
    if (selectable) {
