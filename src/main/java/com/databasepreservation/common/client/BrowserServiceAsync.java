...
public interface BrowserServiceAsync {
  ...
  void uploadSIARD(String path, String databaseUUID, AsyncCallback<String> async);
  ...
  void validateSIARD(String databaseUUID, String SIARDPath, String validationReportPath, String allowedTypePath, boolean skipAdditionalChecks,
    AsyncCallback<Boolean> async);
