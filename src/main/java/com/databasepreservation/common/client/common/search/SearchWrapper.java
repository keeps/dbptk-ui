...
public class SearchWrapper extends Composite {
  ...
  public <T extends IsIndexed> SearchWrapper createListAndSearchPanel(ListBuilder<T> listBuilder, boolean isSearchAll) {
    ...
    String extractedTextCopyField = SearchFilters.extractedTextField();
    ...
    if (isSearchAll) {
      ...
      searchPanel = new SearchPanelWithSearchAll(filter, metadataCopyField, extractedTextCopyField,
        messages.searchPlaceholder(), hasMultipleSearchPanels, false);
    } else {
      searchPanel = new SearchPanel(filter, metadataCopyField, extractedTextCopyField, messages.searchPlaceholder(),
