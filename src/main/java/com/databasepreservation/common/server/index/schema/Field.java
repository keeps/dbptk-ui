...
public class Field {
  ...
  public static void initialize(ViewerConfiguration configuration) {
    String stemmingLanguage = configuration.getViewerConfigurationAsString(null,
      ViewerConfiguration.PROPERTY_SOLR_STEMMING_LANGUAGE);
