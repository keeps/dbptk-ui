...
public class BreadcrumbManager {
  ...
  public static List<BreadcrumbItem> forSIARDIngesting(final String databaseUUID, final String databaseName) {
    ...
    items
      .add(new BreadcrumbItem(SafeHtmlUtils.fromSafeConstant(FontAwesomeIconManager.getTag(FontAwesomeIconManager.WRITE)
        + SafeHtmlUtils.htmlEscape(messages.breadcrumbTextForSIARDIngesting())), new Command() {
          @Override
          public void execute() {
  ...
  public static List<BreadcrumbItem> forManageDatabase() {
    ...
    items.add(
      new BreadcrumbItem(SafeHtmlUtils.fromSafeConstant(FontAwesomeIconManager.getTag(FontAwesomeIconManager.SERVER)
        + SafeHtmlUtils.htmlEscape(messages.breadcrumbTextForManageDatabase())), new Command() {
          @Override
          public void execute() {
