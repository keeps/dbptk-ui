 ...
 * details.
 */
public class GwtTestdbviewer extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "com.databasepreservation.dbviewer.dbviewerJUnit";
  }
   ...
   * BrowserService and verify the response.
   */
  public void testBrowserService() {
    // Create the service that we will test.
    BrowserServiceAsync browserService = GWT.create(BrowserService.class);
    ServiceDefTarget target = (ServiceDefTarget) browserService;
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "dbviewer/greet");
    ...
    browserService.greetServer("GWT User", new AsyncCallback<String>() {
