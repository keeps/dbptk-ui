...
import com.databasepreservation.dbviewer.shared.client.Tools.Humanize;
...
public class SearchFieldPanel extends Composite {
  ...
  public void setSearchAdvancedFields(ListBox searchAdvancedFieldOptions) {
    // ListboxUtils.copyValues(searchAdvancedFieldOptions,
  ...
  public void selectSearchField(String field) {
    // TODO: ListboxUtils.select(searchAdvancedFields, field);
  ...
  public FilterParameter getFilter() {
    ...
    if (searchFields != null && searchFields.size() >= 1) {
      ...
      // } else if
      // (type.equals(RodaConstants.SEARCH_FIELD_TYPE_NUMERIC_INTERVAL)
      ...
      // valid(inputCheckBox)) {
      // filterParameter = new SimpleFilterParameter(field,
      // Boolean.toString(inputCheckBox.getValue()));
