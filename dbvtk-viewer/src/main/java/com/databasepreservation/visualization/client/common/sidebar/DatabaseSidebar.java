...
public class DatabaseSidebar extends Composite {
  ...
  private void init() {
    ...
    sidebarGroup.add(new SidebarHyperlink(messages.titleReport(), HistoryManager.linkToDatabaseReport(database
      .getUUID())).addIcon(FontAwesomeIconManager.DATABASE_REPORT).setH6().setIndent1());
